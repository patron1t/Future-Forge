...
export default function ProfessionalsPage() {
  ...
  useEffect(() => {
    ...
    if (hash === "access-plans" || hash === "plans-section") {
      const element =
        document.getElementById("access-plans") ||
      ...
      <section className="bg-primary/5 py-20 md:py-32">
        <div className="container px-4 text-center">
          <Badge className="mb-4" variant="secondary">
            For Employers, Scouts & Counselors
          </Badge>

          <h1 className="mb-6 font-heading text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl">
            Access <span className="text-primary">Top Talent</span> Before
            Competitors
          </h1>

          <p className="mx-auto mb-8 max-w-2xl text-lg text-muted-foreground">
            Access a curated pool of high-potential students mapped by our AI
            based on their actual strengths, projects, and digital footprint.
            Counselors get free access.
          </p>
          ...
          <div className="flex justify-center gap-4 flex-col sm:flex-row">
            <Button
              ...
              onClick={() =>
                setLocation("/auth?signup=true&role=professional")
              }
            >
              Start Scouting
            </Button>
            ...
            <Button
              ...
              variant="outline"
              onClick={() =>
                document.getElementById("access-plans")?.scrollIntoView({
                  behavior: "smooth",
                })
              }
            >
          ...
          <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-3">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">
                Don't just look at grades. See cognitive strengths, soft
                skills, and project portfolios that prove ability.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">
                Our AI maps students to your organization's needs, reducing
                mismatch and identifying future leaders early.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">
                Showcase your company or university directly to engaged students
          ...
          <div className="mb-16 text-center">
            ...
            <p className="mt-4 text-muted-foreground">
              ...
              <span className="font-semibold text-primary">
                School counselors have free access.
              </span>
            </p>
          </div>
          ...
          <div className="mx-auto grid max-w-5xl gap-8 md:grid-cols-3">
            ...
            <Card className="border-accent/30 bg-accent/5">
              ...
              <CardContent>
                ...
                <Button
                  ...
                  onClick={() =>
                    setLocation("/auth?signup=true&role=counselor")
                  }
                >
                  Create Free Account
                </Button>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  For independent talent scouts and small agencies.
                </CardDescription>
                <div className="mt-4 text-4xl font-bold">
                  $49
                  <span className="text-lg font-normal text-muted-foreground">
              ...
              <CardContent>
                <ul className="space-y-3">
                  <li className="flex items-center gap-2">
                    ...
                    <span>View 100 student profiles/mo</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="h-4 w-4 text-primary" />
                    <span>Basic advanced filtering</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="h-4 w-4 text-primary" />
                    <span>Direct messaging</span>
            ...
            <Card className="border-primary bg-primary/5">
              <CardHeader>
                ...
                <CardDescription>
                  For universities, large employers, and academies.
                </CardDescription>
                <div className="mt-4 text-4xl font-bold">
                  $199
                  <span className="text-lg font-normal text-muted-foreground">
