      ...
      <div className="container px-4 py-12 md:py-16">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground max-w-xs">Smart Careers. Strong Identities. Creating the billionaires of tomorrow through personalized, AI-driven guidance.</p>
          </div>
          <div>
